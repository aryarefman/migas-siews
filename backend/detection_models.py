...
FIRE_SMOKE_CONFIDENCE_THRESHOLD = 0.45  # YOLO-level filter for live stream
FIRE_CONFIDENCE_THRESHOLD = 0.50        # Post-filter for fire (lowered for safety)
SMOKE_CONFIDENCE_THRESHOLD = 0.50       # Post-filter for smoke (lowered for safety)
